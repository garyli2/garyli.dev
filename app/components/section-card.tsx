...
const SectionCard = ({
    ...
    return (
        <div className={`flex flex-col rounded-3xl shadow-lg ring-1 ring-slate-300/60 dark:ring-white/5 ${className}`}>
            <div className="flex items-center gap-2 px-6 py-4 bg-white dark:bg-[#1a2535] border-b border-slate-300 dark:border-white/5 [border-top-left-radius:inherit] [border-top-right-radius:inherit]">
