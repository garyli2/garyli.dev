    ...
    return (
        <Card className={classes.root}>
            <CardHeader
                avatar={
                    <img
                        src="https://steps4news.web.app/static/images/icon.png"
                        style={{ width: "45px" }}
                    ></img>
                }
            ...
            <CardContent>
                <Typography variant="body1" color="textPrimary" component="p">
                    An Android app to help you stay up to date with the latest
            ...
            <CardActions disableSpacing>
                ...
                <AwesomeButton
                    ...
                    type="primary"
                    onPress={() =>
                        window.open("https://steps4news.web.app", "_blank")
                    }
                >
                    Visit
                </AwesomeButton>
